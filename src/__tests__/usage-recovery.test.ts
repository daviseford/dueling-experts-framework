...
describe('recoverUsageState', () => {
  ...
  it('cumulative cost can be computed from recovered entries', async () => {
    ...
    // Cumulative cost should reflect all recovered entries
...
describe('retry usage accumulation (orchestrator pattern)', () => {
  ...
  it('accumulated cost reflects all invocations, not just the initial invoke', () => {
    // If initial invoke cost $0.05 and retry cost $0.05, total should be double
    ...
    // The accumulated cost should exceed the initial invoke cost alone
